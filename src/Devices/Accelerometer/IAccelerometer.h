...
public:
     ...
     * 
     * Configures the sensor's output data rate. The actual rate depends
     * on the specific sensor hardware and driver implementation.
     * 
     * @param rate Data rate value (sensor-specific encoding)
     */
    virtual void setDataRate(uint8_t rate) = 0;
